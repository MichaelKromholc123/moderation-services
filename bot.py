...
discordbotversion = "1.1.5"

lastupdate = "11th Sep 2021"
...
bot = commands.Bot(discordbotprefix)
...
async def slowmode(ctx, seconds: int):
    ...
    slowmodeembed = discord.Embed(colour=discord.Colour(0xd0021b), description=f"```This Channels Slowmode Has Been Set To {seconds} By {ctx.message.author.name}```")
...
async def lock(ctx, channel : discord.TextChannel=None):
    ...
    lockembed = discord.Embed(colour=discord.Colour(0xd0021b), description=f"```This Channel Has Been Locked By {ctx.message.author.name}```")
...
async def unlock(ctx, channel : discord.TextChannel=None):
    ...
    unlockembed = discord.Embed(colour=discord.Colour(0xd0021b), description=f"```This Channel Has Been Unlocked By {ctx.message.author.name}```")
...
async def help(ctx):
    ...
    helpembed.add_field(name="Support Server:", value="||https://discord.gg/vnxZfqMcM8||", inline=False)
...
async def ban (ctx, member:discord.User=None, reason =None):
    if member == ctx.message.author:
        ...
        banyourselfembed = discord.Embed(colour=discord.Colour(0xd0021b), description="```Sorry But You Cant Ban Yourself Please Mention Another User To Ban```")
        ...
        return
    if member == None:
        invalidargumentembed = discord.Embed(colour=discord.Colour(0xd0021b), description="```Please Make Sure You Mention A Member To Ban```")
...
async def unban(ctx, id: int):
    ...
    unbanembed = discord.Embed(colour=discord.Colour(0xd0021b), description=f"```I Have Unbanned A User With The Id {id}```")
...
async def lock_error(ctx, error):
    if isinstance(error, commands.MissingPermissions):
        lockerrorembed = discord.Embed(colour=discord.Colour(0xd0021b), url="https://discordapp.com", description="```Sorry, You Need The MANAGE CHANNELS To Do That If You Think This Is A Bug Please Report It.```")
...
async def unlock_error(ctx, error):
    if isinstance(error, commands.MissingPermissions):
        unlockerrorembed = discord.Embed(colour=discord.Colour(0xd0021b), url="https://discordapp.com", description="```Sorry, You Need The MANAGE CHANNELS To Do That If You Think This Is A Bug Please Report It.```")
...
async def clean_error(ctx, error):
    if isinstance(error, commands.MissingPermissions):
        cleanerrorembed = discord.Embed(colour=discord.Colour(0xd0021b), url="https://discordapp.com", description="```Sorry, You Need The MANAGE MESSAGES To Do That If You Think This Is A Bug Please Report It.```")
...
async def slowmode_error(ctx, error):
    if isinstance(error, commands.MissingPermissions):
        slowmoderrorembed = discord.Embed(colour=discord.Colour(0xd0021b), url="https://discordapp.com", description="```Sorry, You Need The MANAGE CHANNELS To Do That If You Think This Is A Bug Please Report It.```")
...
async def on_command_error(ctx, error):
  if isinstance(error, commands.CommandNotFound):
    missingcommanderror = discord.Embed(colour=discord.Colour(0xd0021b), url="https://discordapp.com", description="```Sorry, I Cant Find That Command If Your Sure Its A Command Do c!help To Make Sure You Didnt Misspell Anything.```")
...
async def invite(ctx):
    inviteembed = discord.Embed(colour=discord.Colour(0xd0021b), description="```Click On Invite Me To Invite Me To Your Server Today. Need More Help Inviting Me? Do c!website For A Link To Our Website Were You Can Find Out More.```")
...
async def website(ctx):
    websiteembed = discord.Embed(colour=discord.Colour(0xd0021b), description="```Click On The Text Above To Goto The Server Cleaner Offical Website! (Here You Can Find The Invite A List Of Features Ect.)```")
...
async def version(ctx):
    versionembed = discord.Embed(colour=discord.Colour(0xd0021b), description=f"```My Current Version Is {discordbotversion} And I Was Last Updated {lastupdate}```")
...
@bot.command()
async def setup(ctx):
    setupembed = discord.Embed(colour=discord.Colour(0xd0021b), description="```This Feature Is Not Yet Available However It Will Be Soon, Until Then Use c!help For A List Of Commands.```")
...
bot.run('ODg2MzIxMTI5MTIyMzE2MzI4.YTz44A.Deibxq_Ho5vfAjMpNaN-vbN92Kg')
